...
class SunnahTodayChart extends StatefulWidget {
  const SunnahTodayChart({
    super.key,
  ...
  @override
  State<SunnahTodayChart> createState() => SunnahTodayChartState();
}

class SunnahTodayChartState extends State<SunnahTodayChart> {
